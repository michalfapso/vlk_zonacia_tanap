layers = [
    ...
    Heron.scratch.layermap.zonacia_TANAP,
    Heron.scratch.layermap.zonacia_NAPANT,
    Heron.scratch.layermap.zonacia_NAPANT_OP,
    Heron.scratch.layermap.zonacia_NAPANT_EFP,
    ...
    Heron.scratch.layermap.zonacia_poloniny,
    //SM, 18.01.2021 >>>
    ...
    Heron.scratch.layermap.hluchan_biotopy_levocske,
    Heron.scratch.layermap.hluchan_biotopy_slovensko,
    Heron.scratch.layermap.hluchan_funckne_lokality,
    Heron.scratch.layermap.hluchan_funkcne_biotopy_lower,
    Heron.scratch.layermap.hluchan_funkcne_biotopy_upper,
    Heron.scratch.layermap.hluchan_klenovsky_vepor,
    Heron.scratch.layermap.hluchan_orava_kysuce,
    Heron.scratch.layermap.hluchan_potencialne_bez_evid,
    Heron.scratch.layermap.hluchan_potencialne_bez_potvrd,
    Heron.scratch.layermap.hluchan_raj_volovske,
    Heron.scratch.layermap.hluchan_rozsirenie_polana,
    Heron.scratch.layermap.hluchan_strazovske_vrchy,
    Heron.scratch.layermap.hluchan_svrcnik,
    Heron.scratch.layermap.hluchan_vysoke_tatry,
...
if (Heron.options.map.layers) {
    ...
    Heron.options.map.layers = layers;
}
